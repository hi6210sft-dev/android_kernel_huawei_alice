...
/*ICC_LOG_SAVE DTS:DTS2013060606474 modifier: yuanfang 00241633 begin*/
...
/*ICC_LOG_SAVE DTS:DTS2013060606474 modifier: yuanfang y00241633 begin*/
...
/*****************************************************************************
* 函 数 名  : ICC_a_core_LogFileSave
*
* 功能描述  : A核log文件保存函数
*
* 输入参数  : dirName :     log文件保存路径
              fileHeader :  log文件文件名
              address :     待保存数据
              length :      数据长度
*
* 输出参数  :
*
* 返 回 值  : 文件保存状态BSP_OK 、 BSP_ERROR
* 修改说明: DTS:DTS2013060606474 modifier: yuanfang y00241633
************************************************************************/
...
BSP_VOID ICC_HandleEvent(ICC_CHAN_DEV_S *pChan)
{
    ...
    /* DTS2012071100454 w00193956 2012-7-12 begin*/
    local_irq_save(flag);
    /* DTS2012071100454 w00193956 2012-7-12 end*/
...
/*Modify_for_c_reset, l00212112,20130511, ends*/
    ...
    /*DTS2012091305058 d00221159 2012-10-12 begin*/
    /*
    ...
    */
    return s32CopySize;
    /*DTS2012091305058 d00221159 2012-10-12 end*/
